...
public class ModEntities
{
	...
	public static void init()
	{
		...
		EntityRegistry.addSpawn(EntityHellhound.class, 12, 1, 3, EnumCreatureType.MONSTER, netherBiomes.toArray(new Biome[0]));
		...
		EntityRegistry.addSpawn(EntityiSheep.class, 12, 1, 4, EnumCreatureType.MONSTER, netherBiomes.toArray(new Biome[0]));
		...
		EntityRegistry.addSpawn(EntityZlama.class, 12, 1, 4, EnumCreatureType.MONSTER, netherBiomes.toArray(new Biome[0]));
