...
public class EnchantmentElytra extends Enchantment
{
	public EnchantmentElytra(String name)
	{
	...
	{
		return ench instanceof EnchantmentWings ? false : super.canApplyTogether(ench);
	}
