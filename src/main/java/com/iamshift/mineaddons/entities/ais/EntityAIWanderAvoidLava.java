...
public class EntityAIWanderAvoidLava extends EntityAIWander
{
	protected final float probability;

	public EntityAIWanderAvoidLava(EntityCreature p_i47301_1_, double p_i47301_2_)
	{
		this(p_i47301_1_, p_i47301_2_, 0.001F);
	}

	public EntityAIWanderAvoidLava(EntityCreature p_i47302_1_, double p_i47302_2_, float p_i47302_4_)
	{
