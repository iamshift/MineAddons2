...
public class RenderSpiritBomb extends Render<EntitySpiritBomb>
{

	public RenderSpiritBomb(RenderManager renderManagerIn)
	{
		super(renderManagerIn);
	}

	public void doRender(EntitySpiritBomb entity, double x, double y, double z, float entityYaw, float partialTicks) 
	{
	...
	@Override
	protected ResourceLocation getEntityTexture(EntitySpiritBomb entity)
	{
