...
public class BlockWhiteSandStoneStairs extends BlockStairs implements IHasModel, IRecipeProvider
{
	public BlockWhiteSandStoneStairs(String name)
	{
		super(ModBlocks.WhiteSandstone.getDefaultState());
	...
	public List<IRecipe> getRecipe()
	{
		...
		list.add(
				...
				}).setRegistryName(new ResourceLocation(Refs.ID, "white_sandstone_stairs"))
				);
