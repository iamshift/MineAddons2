...
public class BlockAlloyFiberStar extends BlockFluidClassic implements IHasModel
{
	public BlockAlloyFiberStar(String name)
	{
		super(ModFluids.FiberStar, Materials.ALLOY_FIBERSTAR);
