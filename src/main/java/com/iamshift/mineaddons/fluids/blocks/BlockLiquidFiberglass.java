...
public class BlockLiquidFiberglass extends BlockFluidClassic implements IHasModel
{
	public BlockLiquidFiberglass(String name)
	{
		super(ModFluids.Fiberglass, Materials.FIBERGLASS);
