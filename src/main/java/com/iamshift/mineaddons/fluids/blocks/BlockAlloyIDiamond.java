...
public class BlockAlloyIDiamond extends BlockFluidClassic implements IHasModel
{
	public BlockAlloyIDiamond(String name)
	{
		super(ModFluids.InfusedDiamond, Materials.ALLOY_IDIAMOND);
